...
const AREAS = [
  'Koramangala', 'Whitefield', 'Indiranagar', 'JP Nagar', 'Jayanagar',
  'HSR Layout', 'Marathahalli', 'Electronic City', 'Malleshwaram', 'Yelahanka',
];
      ...
      >
        ...
        <div className="bg-blue-50 border border-blue-100 rounded-xl px-4 py-3 mb-6 flex items-start gap-3">
          ...
          <div className="text-sm text-blue-700">
            <strong>How it works:</strong> The BESCOM EV Agent analyses real-time grid load, tariff schedules,
            and zone demand patterns to recommend charging windows that minimize peak stress.
        ...
        <div className="grid gap-5 lg:grid-cols-2 mb-5">
          <AgentPanel
            title="Grid Conditions & Feeder Status"
            icon="⚡"
            query="What are current grid conditions across Bangalore zones? Which feeders are under stress? List top 5 stressed feeders and recommended actions."
            minHeight="180px"
            maxHeight="340px"
          />
          <AgentPanel
