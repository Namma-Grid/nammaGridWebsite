        ...
        <div className="bottom-sheet">
          ...
          {bestStation && (
            <div className="p-3 rounded-xl bg-emerald-50 border border-emerald-200">
              <p className="text-xs font-bold text-emerald-700 mb-1">⚡ We recommend stopping at:</p>
              <p className="text-sm font-bold text-emerald-800">{bestStation.name}</p>
              <p className="text-[11px] text-emerald-600">{bestStation.kw}kW fast charger · {bestStation.operator} · currently low wait</p>
            </div>
          )}
        </div>
      )}
